...
Status: raised during v0.101.0 on 2026-09-25 from the second source-text test lane (its mounted GraphCanvas tests) and confirmed by the independent review of that lane at `main` `a83900a29`.
