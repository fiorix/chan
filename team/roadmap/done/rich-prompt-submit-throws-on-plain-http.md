...
Status: shipped in [v0.100.0](../../release/release-v0.100.0.md): Ids are minted through one helper that works in every context chan is served in, so Rich Prompt submits on a devserver reached over plain http.
