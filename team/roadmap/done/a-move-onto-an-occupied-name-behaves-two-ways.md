...
Status: shipped in [v0.100.0](../../release/release-v0.100.0.md): Every move gesture refuses a collision and names the occupied path, and the overwrite confirm the server never honoured is gone.
