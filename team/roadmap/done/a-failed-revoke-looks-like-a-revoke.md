...
Status: shipped in [v0.100.0](../../release/release-v0.100.0.md): A failed revoke says so next to what was not revoked, the token and grant lists stay current, and revocation is confirmed through the app's own modal.
