...
Status: shipped in [v0.100.0](../../release/release-v0.100.0.md): The COPR publication probe waits 7,200 seconds, sized from the measured worst normal release, with trigger and verify as separate jobs.
