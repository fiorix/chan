...
Status: shipped in [v0.100.0](../../release/release-v0.100.0.md): The foreign-holder lock probe is three-state, so a transient open failure reads as `unknown` with its reason instead of another process holding the lock.
