...
Status: shipped in [v0.100.0](../../release/release-v0.100.0.md): The connecting window offers Retry only after the connection has failed or timed out, and announces state changes rather than the clock.
