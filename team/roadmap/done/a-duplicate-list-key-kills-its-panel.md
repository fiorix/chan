...
Status: shipped in [v0.100.0](../../release/release-v0.100.0.md): List keys are unique for every shape the server may send, and a render throw in a pane, an inspector section or the launcher's deck is contained with a retry.
