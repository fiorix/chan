...
Status: shipped in [v0.100.0](../../release/release-v0.100.0.md): Every turn-on verb answers 200 with the workspace's launcher row, the connected-devserver route included, and refusals keep their codes and bodies.
