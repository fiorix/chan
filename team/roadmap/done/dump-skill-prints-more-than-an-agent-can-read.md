...
Status: shipped in [v0.100.0](../../release/release-v0.100.0.md): `chan dump-skill` prints an index by default, topic pages split into indexed parts under an 8 KiB budget, and `--full` is the explicit unbounded export.
