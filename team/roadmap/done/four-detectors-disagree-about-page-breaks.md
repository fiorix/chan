...
Status: shipped in [v0.100.0](../../release/release-v0.100.0.md): `<hr class="chan-page-break">` is the one page break every surface detects, with near misses normalized on write and `@pagebreak` kept as an authoring macro.
