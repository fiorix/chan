...
Status: SHIPPED in [v0.83.4](../../release/release-v0.83.4.md). The Rich Prompt recovers from a failed draft create with a visible error and a working retry, and keyboard paste is no longer suppressed on the Ghostty backend.
