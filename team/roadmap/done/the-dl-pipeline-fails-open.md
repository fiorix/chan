...
Status: shipped in [v0.100.0](../../release/release-v0.100.0.md): The `/dl` pipeline errors on a missing tag, spells asset names once, and requires a signature for every updater payload it can publish.
