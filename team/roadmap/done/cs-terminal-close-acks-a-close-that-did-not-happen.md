...
Status: shipped in [v0.100.0](../../release/release-v0.100.0.md): `cs terminal close` waits within a shared deadline for every closed session's child to end and fails naming each survivor instead of acknowledging a close that did not happen.
