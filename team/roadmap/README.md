...
| [gateway-served-surface-failures](v0.84.0/gateway-served-surface-failures.md) | registered, not specced | ground why paste, the Rich Prompt composer, and the launcher's Computers section fail only when the devserver is reached through the gateway |
