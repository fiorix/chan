...
| [the-webgl-present-stall-is-unmeasured-and-costs-linux-the-grid](v0.89.0/the-webgl-present-stall-is-unmeasured-and-costs-linux-the-grid.md) | registered 2026-08-10, the residual of a partial v0.88.0 item | establish whether the WebGL present stall still reproduces; if it does not, turning the renderer on for the Linux desktop closes the grid banding outright. Needs an Xorg session on real hardware, which the v0.88.0 round did not have |
