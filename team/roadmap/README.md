...
| [rich-prompt-submit-button](v0.84.0/rich-prompt-submit-button.md) | registered, grounded, ruled, specified, ready to implement | turn the Rich Prompt's hint into a control strip whose primary button submits and becomes cancel while a prompt is in flight |
