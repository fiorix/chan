...
Status: raised for v0.100.0 on the owner's instruction to fold the frontend review's most critical findings into this version. From the review (finding TAB-01, high, and the renderer keyboard contract of its Phase 2), re-verified against `main` at `d3de0180b` by reading. The Ctrl+F half waits on an owner ruling, named below.
