...
Status: raised for v0.100.0 from the v0.99.0 fix loop's follow-ups, where an independent review recorded it and it was parked. A source reading against `main` at `d3de0180b`; the race was not reproduced.
