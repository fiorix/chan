...
Status: raised for v0.100.0 on the owner's instruction to fold the frontend review's most critical findings into this version. From the review (findings SHELL-01, OVL-02, OVL-03, WSWS-01 and CMD-03, medium, which compose into the input-blocking contract of its Phase 2), re-verified against `main` at `d3de0180b` by reading.
