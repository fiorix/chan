...
Status: raised for v0.100.0 on the owner's instruction to fold the frontend review's most critical findings into this version. From the review (finding TABS-02, high), re-verified against `main` at `d3de0180b` by reading.
