...
assert_out "a host without Linux or Nix harvests in a Linux container, or asks a maintainer to" "the failure names the route for a host that runs neither harvest"
