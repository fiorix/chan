...
flowchart TD
    ...
    Status -->|"401 / compatibility 403 / other"| Failed["emit DialFailed"]
...
- Response codes that `dial` recognises:
  ...
  - `403 FORBIDDEN`: accepted for version-skew robustness and mapped to the same generic unauthorized error.
