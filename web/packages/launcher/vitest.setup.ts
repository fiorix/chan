...
//
// The workspace app carries the same shim. Both are loaded through
// their package's `setupFiles`, so a test that drives a persistence
// seam reads the same Storage in either package.
//
